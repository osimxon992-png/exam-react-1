...
const Dashboard = () => {
  ...
  const API = "https://dummyjson.com/recipes?limit=7";
  ...
  return (
    <div className="container">
      <section
        className={`w-full h-[750px] ${mode ? "bg-[#fff]" : "bg-[#11142D]"}`}
      >
        <header
        ...
        >
          <div
            className={`h-[690px] border-r p-[40px_27px] ${
              mode
          ...
          >
            <div
              ...
              className={`h-[56px] rounded-[8px] aktiv mb-[12px] ${
                mode
                  ? "hover:text-[#000] text-[#9A9AB0]"
                  : "hover:text-[#fff] text-[#E1E1E1]"
              }  ${
                open
            ...
            <div
              className={`h-[56px] rounded-[8px] aktiv  mb-[150px] ${
                mode
                  ? "hover:text-[#000] text-[#9A9AB0]"
                  : "hover:text-[#fff] text-[#E1E1E1]"
              }  ${
            ...
            <div
              className={`h-[56px] rounded-[8px] aktiv ${
                mode
                  ? "hover:text-[#000] text-[#9A9AB0]"
                  : "hover:text-[#fff] text-[#E1E1E1]"
              }  ${
          ...
          <div className="flex gap-[32px] w-full max-h-[670px] overflow-y-scroll">
            <div
              className={`w-[832px] h-[1380px] rounded-[8px] ${
                mode
                  ? "bg-[#FFFFFF]"
                  : "bg-[transparent] border border-[#5266e8]"
              } mt-[40px] p-[24px_16px]`}
            >
              <div
              ...
              <div>
                ...
                <div
                  className={`flex items-center flex-wrap  mb-[32px] ${open ? "gap-[8px]" : "gap-[5px]"}`}
                >
